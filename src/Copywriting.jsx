...
const Copywriting = () => {
  return (
    <>
      <p className="text-[18px] lg:text-[28px] leading-[1.4] font-semibold font-sans w-full sm:w-[600px] lg:w-[1100px] mx-auto bg-transparent text-center bg-gray-100 mt-10 rounded-lg px-4 sm:px-6 lg:px-8">
      ...
      <p className="text-[16px] lg:text-[23px] leading-[1.4] font-semibold font-sans w-full sm:w-[600px] lg:w-[1100px] mx-auto bg-transparent text-center bg-gray-100 mt-10 rounded-lg px-4 sm:px-6 lg:px-8">
        An editor earns around ₹560,000 per annum on average, while top-tier editors can earn as much as ₹2,500,000.
      </p>
      ...
      <p className="text-[45px] lg:text-[90px] text-green-500 leading-[1.4] font-extrabold font-sans w-full sm:w-[600px] lg:w-[1100px] mx-auto bg-transparent text-center mt-10 rounded-lg">
        99%
      </p>
    </>
  )
